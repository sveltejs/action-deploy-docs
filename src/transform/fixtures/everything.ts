		...
		content: {
			...
			full: [
				...
				},
				{
					...
					content:
						'<h3><span id="package-json-type-module" class="offset-anchor"></span><a href="docs#package-json-type-module" class="anchor" aria-hidden></a>type : "module"</h3>\n<p>Add <code>"type": "module"</code> to your <code>package.json</code></p>\n<h3><span id="package-json-dependencies" class="offset-anchor"></span><a href="docs#package-json-dependencies" class="anchor" aria-hidden></a>dependencies</h3>\n<p>Remove <code>polka</code> or <code>express</code>, if you\'re using one of those, and any middleware such as <code>sirv</code> or <code>compression</code>.</p>\n<h3><span id="package-json-devdependencies" class="offset-anchor"></span><a href="docs#package-json-devdependencies" class="anchor" aria-hidden></a>devDependencies</h3>\n<p>Remove <code>sapper</code> from your <code>devDependencies</code> and replace it with <code>@sveltejs/kit</code>, <code>vite</code>, and whichever <a href="/docs#adapters" rel="noopener noreferrer">adapter</a> you plan to use (see <a href="#project-files-configuration" rel="noopener noreferrer">next section</a>).</p>\n<h3><span id="package-json-scripts" class="offset-anchor"></span><a href="docs#package-json-scripts" class="anchor" aria-hidden></a>scripts</h3>\n<p>Any scripts that reference the <code>sapper</code> binary should be updated:</p>\n<ul>\n<li><code>sapper build</code> or <code>sapper export</code> should become <a href="/docs#command-line-interface-svelte-kit-build" rel="noopener noreferrer">svelte-kit build</a></li>\n<li><code>sapper dev</code> should become <a href="/docs#command-line-interface-svelte-kit-dev" rel="noopener noreferrer">svelte-kit dev</a></li>\n</ul>\n<p>Additionally, <a href="/docs#command-line-interface-svelte-kit-start" rel="noopener noreferrer">svelte-kit start</a> replaces any command that invokes your Sapper-built server.</p>',
				},
				{
					title: "Project files",
					slug: "project-files",
